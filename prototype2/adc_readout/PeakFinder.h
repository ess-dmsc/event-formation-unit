...
private:
  ...
  /// Currently uses the EventMessage flatbuffer schema for serialisation. This is not a good fit for the analysed data and another schema should probably be used.
