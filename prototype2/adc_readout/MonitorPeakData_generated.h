...
struct MonitorPeakData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint16_t Amplitude() const {
    return GetField<uint16_t>(VT_AMPLITUDE, 0);
  }
  bool mutate_Amplitude(uint16_t _Amplitude) {
    return SetField<uint16_t>(VT_AMPLITUDE, _Amplitude, 0);
  }
...
struct MonitorPeakDataBuilder {
  ...
  void add_TimeStamp(uint64_t TimeStamp) {
    fbb_.AddElement<uint64_t>(MonitorPeakData::VT_TIMESTAMP, TimeStamp, 0);
  }
  void add_Amplitude(uint16_t Amplitude) {
    fbb_.AddElement<uint16_t>(MonitorPeakData::VT_AMPLITUDE, Amplitude, 0);
  }
  void add_Channel(uint16_t Channel) {
    fbb_.AddElement<uint16_t>(MonitorPeakData::VT_CHANNEL, Channel, 0);
  }
  void add_Name(flatbuffers::Offset<flatbuffers::String> Name) {
    fbb_.AddOffset(MonitorPeakData::VT_NAME, Name);
  }
  explicit MonitorPeakDataBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
  ...
  flatbuffers::Offset<MonitorPeakData> Finish() {
    ...
    auto o = flatbuffers::Offset<MonitorPeakData>(end);
    fbb_.Required(o, MonitorPeakData::VT_NAME);
    return o;
  }
};

inline flatbuffers::Offset<MonitorPeakData> CreateMonitorPeakData(
...
inline flatbuffers::Offset<MonitorPeakData> CreateMonitorPeakDataDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t TimeStamp = 0,
    uint16_t Amplitude = 0,
    uint16_t Channel = 0,
    const char *Name = nullptr) {
  return CreateMonitorPeakData(
      _fbb,
      TimeStamp,
      Amplitude,
      Channel,
...
inline bool MonitorPeakDataBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(
      buf, MonitorPeakDataIdentifier());
}

inline bool VerifyMonitorPeakDataBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MonitorPeakData>(MonitorPeakDataIdentifier());
}

inline void FinishMonitorPeakDataBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<MonitorPeakData> root) {
