...
// of low-level memory barriers, plus a few semi-portable utility macros (for
// inlining and alignment).
// Also has a basic atomic type (limited to hardware-supported atomics with no
// memory ordering guarantees).
// Uses the AE_* prefix for macros (historical reasons), and the "moodycamel"
...
// are provided.
// The guarantee of atomicity is only made for types that already have atomic
// load and store guarantees
// at the hardware level -- on most platforms this generally means aligned
