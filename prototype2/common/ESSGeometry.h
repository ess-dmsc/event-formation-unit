...
public:
  ...
  inline uint32_t getmaxpixel() { return nxyzp_; }
  ...
  inline uint32_t xcoord(uint32_t pixel) { return (pixel - 1) % nx_; }

  /** @brief get y coordinate from pixelid */
  inline uint32_t ycoord(uint32_t pixel) { return ((pixel - 1) / nx_) % ny_; }

  /** @brief get z coordinate from pixelid */
  inline uint32_t zcoord(uint32_t pixel) { return ((pixel - 1) / nxy_) % nz_; }

  /** @brief get p coordinate from pixelid */
  inline uint32_t pcoord(uint32_t pixel) { return (pixel - 1) / nxyz_; }
