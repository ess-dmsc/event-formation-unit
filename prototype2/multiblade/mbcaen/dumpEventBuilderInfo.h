...
private:
     ...
     * Two counters for 2D clusters (wire and strips signals) and two counters for 1D clusters.
    ...
    /*! Prints number of events with more than 5 signals per cluster/event for either wire or strip */
