    ...
    return {
        node('system-test') {
			...
			timeout(time: 30, activity: true){
                            sh """cd system-tests/
                            scl enable rh-python35 -- python -m pytest -s --pcap-file-path /home/jenkins/data/EFU_reference/multiblade/2018_11_22/wireshark --json-file-path /home/jenkins/data/EFU_reference/multiblade/2018_11_22 --junitxml=./SystemTestsOutput.xml ./
                            """
			}
                    }  // stage
                }finally {
