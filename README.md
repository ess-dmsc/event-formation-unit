...
Note also that for additional functionality you migth want to install the following dependencies:
...
* [**Streaming Data Types**](https://github.com/ess-dmsc/streaming-data-types) Note that this dependency should not be installed.
* [**ESSGeometry**](https://github.com/ess-dmsc/logical-geometry) __This needs to be fixed.__
...
**Make sure to remove the h5cpp repository before running cmake. WHY?**

After having installed the dependencies, this code in this repository can be compiled. Note that when running *cmake*, you have to also set the path to the header files generated by the Streaming Data Types project as illustrated in the following example:
...
cmake -DCMAKE_CXX_FLAGS="-I/some_path/streaming-data-types/build/schemas/" ..
...
* h5cppConfig.cmake in home directory problem
