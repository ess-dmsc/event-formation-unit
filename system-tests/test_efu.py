...
def test_efu_received_all_sent_udp_packets(docker_compose):
    # TODO: The comment below is misleading, as we cannot reason about system load. Make this use a proper timeout instead.
    sleep(1000)  # Wait plenty of time for the EFU to receive and process the event data
