...
def test_efu_received_all_sent_udp_packets(docker_compose):
    sleep(200)  # Wait plenty of time for the EFU to receive and process the event data
    res, name, op, value, retval = verify_metric("localhost", 8889, "efu.mbcaen.receive.packets:30870")
