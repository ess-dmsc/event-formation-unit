...
TEST_F(ReadoutTest, Constructor) {
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_BUFFER), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SIZE), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_VERSION), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TYPE), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SEQNO), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_OUTPUT_QUEUE), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TIMEHIGH), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TIMEFRAC), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_VERSION_V0), 0);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_VERSION_V1), 0);
}
...
TEST_F(ReadoutTest, ErrorBufferPtr) {
  ...
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_BUFFER), 1);
}
...
TEST_F(ReadoutTest, HeaderLTMin) {
  ...
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SIZE), 1);
}
...
TEST_F(ReadoutTest, ErrorPad) {
  ...
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_PAD), 1);
}
...
TEST_F(ReadoutTest, ErrVersion) {
  ...
  ASSERT_EQ(Res, -Parser::EHEADER);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_VERSION), 1);
}
...
TEST_F(ReadoutTest, V0HeaderCount) {
  ...
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_VERSION_V0), 1);
}
...
TEST_F(ReadoutTest, V1HeaderCount) {
  ...
  ASSERT_EQ(Res, -Parser::OK);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_VERSION_V1), 1);
}
...
TEST_F(ReadoutTest, ErrMaxOutputQueue) {
  ...
  ASSERT_EQ(Res, -Parser::EHEADER);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_OUTPUT_QUEUE), 1);
}
...
TEST_F(ReadoutTest, OkV0Version) {
  ...
  for (unsigned int Size = MinSize; Size < OkVersionV0.size(); Size++) {
    ...
    ASSERT_EQ(Res, -Parser::ESIZE);
    ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SIZE), Errors);
...
TEST_F(ReadoutTest, SeqNumbers) {
  ...
  ESSParser.validate((char *)&OkVersionV0[0], OkVersionV0.size(), DataType);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SEQNO), 1);
  ...
  ESSParser.validate((char *)&OkVersionNextSeq[0], OkVersionNextSeq.size(),
                 DataType);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_SEQNO), 2);
}
...
TEST_F(ReadoutTest, BadReadoutTypev0) {
  ...
  ASSERT_EQ(Res, -Parser::EHEADER);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TYPE), 1);
}
...
TEST_F(ReadoutTest, PulseTimeFracErrorV0) {
  ...
  ASSERT_EQ(res, -Parser::EHEADER);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TIMEFRAC), 1);
}
...
TEST_F(ReadoutTest, MaxPulseTimeErrorV0) {
  ...
  ASSERT_EQ(res, -Parser::EHEADER);
  ASSERT_EQ(Stats.getValueByName(Parser::METRIC_PARSER_ESSHEADER_ERRORS_TIMEHIGH), 1);
}
