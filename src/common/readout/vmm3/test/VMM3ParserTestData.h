...
std::vector<uint8_t> VMMRingError {
  // First readout
  0x17, 0x00, 0x14, 0x00,  // Data header - Ring 23, FEN 0, Size 20
  ...
  // Second readout
  0x18, 0x01, 0x14, 0x00,  // Data Header - Ring 24!
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x01, 0x00, 0x00, 0x00,  // Time LO 1 tick
  0x00, 0x00, 0x00, 0x01,  // ADC 0x100
  0x00, 0x00, 0x00, 0x00,  // GEO 0, TDC 0, VMM 0, CH 0
...
std::vector<uint8_t> VMMDataLengthError {
  // First readout
  0x01, 0x00, 0x14, 0x00,  // Data header - Ring 1, FEN 0, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x01, 0x00, 0x00, 0x00,  // Time LO 1 tick
  0x00, 0x00, 0x00, 0x01,  // ADC 0x100
  0x00, 0x00, 0x00, 0x00,  // GEO 0, TDC 0, VMM 0, CH 0
  ...
  // Second readout
  0x02, 0x01, 0x15, 0x00,  // Data header - Ring 2, FEN 1, Size 21!
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x01, 0x00, 0x00, 0x00,  // Time LO 1 tick
  0x00, 0x00, 0x00, 0x01,  // ADC 0x100
  0x00, 0x00, 0x00, 0x00,  // GEO 0, TDC 0, VMM 0, CH 0
...
std::vector<uint8_t> VMMTimeLowError {
  ...
  0x02, 0x02, 0x14, 0x00,  // Data header - Ring 2, FEN 2, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x14, 0x93, 0x3F, 0x05,  // Time LO 8802499 tick (max +1)!
  0x00, 0x00, 0x00, 0x01,  // ADC 0x100
  0x00, 0x00, 0x00, 0x00,  // GEO 0, TDC 0, VMM 0, CH 0

  0x03, 0x03, 0x14, 0x00,  // Data header - Ring 3, FEN 3, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
...
std::vector<uint8_t> VMMBCError {
  ...
  0x00, 0x00, 0x14, 0x00,  // Data header - Ring 0, FEN 0, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x01, 0x00, 0x00, 0x00,  // Time LO 1 tick
  ...
  0x01, 0x02, 0x14, 0x00,  // Data header - Ring 1, FEN 2, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
...
std::vector<uint8_t> VMMChannelError {
  ...
  0x01, 0x03, 0x14, 0x00,  // Data header - Ring 1, FEN 3, Size 20
  0x01, 0x00, 0x00, 0x00,  // Time HI 1 s
  0x00, 0x00, 0x00, 0x00,  // Time LO 0 tick (min)
  0x00, 0x00, 0x00, 0x00,  // BC 0x0000 (min), OT 0, ADC 0x0000
