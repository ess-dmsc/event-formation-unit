...
TEST_F(ESSTimeTest, Constructor) {
  ASSERT_EQ(Time.getTOF(0, 0, 0), 0);
}

TEST_F(ESSTimeTest, SetRef) {
  Time.setReference(100, 0);
  ASSERT_EQ(Time.getTOF(100, 0, 0),  0);
  ASSERT_EQ(Time.getTOF(100, 1, 0), 11);
  ASSERT_EQ(Time.getTOF(100, 2, 0), 22);
  ASSERT_EQ(Time.getTOF(100, 3, 0), 34);
  ASSERT_EQ(Time.getTOF(200, 0, 0), 100*1000000000LU);
}
...
TEST_F(ESSTimeTest, Bounds) {
  ...
  ASSERT_EQ(Time.getTOF(1, 0, 0), 12); // why not 11?
}
...
TEST_F(ESSTimeTest, PrevPulse) {
  ...
  ASSERT_EQ(Time.getTOF(100, 100000, 0),  0);
  ASSERT_EQ(Time.getTOF(100, 75000, 0), 0xFFFFFFFFFFFFFFFFULL);

  ASSERT_EQ(Time.getPrevTOF(100, 75000, 0), (uint64_t)(25000 * Time.NsPerTick));
  ASSERT_EQ(Time.getPrevTOF(100, 50000, 0), 0);
  ASSERT_EQ(Time.getPrevTOF(100, 49999, 0), 0xFFFFFFFFFFFFFFFFULL);
