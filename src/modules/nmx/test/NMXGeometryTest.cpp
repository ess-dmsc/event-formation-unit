...
TEST_F(NMXGeometryTest, XAndZCoordinateCalculations) {
...
TEST_F(NMXGeometryTest, InvalidXAndZCoordinates) {
  // invalid HybridID
...
TEST_F(NMXGeometryTest, YCoordinateCalculations) {
...
TEST_F(NMXGeometryTest, InvalidYCoordinates) {
