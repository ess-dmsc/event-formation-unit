...
static constexpr uint64_t timegap{
    2000}; // expect readouts in a plane to be at least this close
...
public:
  ...
  std::vector<std::vector<uint16_t>> Thresholds{
      {34,    5000,  5000,  5000, 5000, 5000,  5000, 10500, 9000, 12000, 5000,
       12500, 13000, 12500, 8000, 9143, 10500, 8000, 8000,  8000, 8000,  10000,
       10000, 5000,  8034,  6000, 6000, 6000,  6000, 6000,  6000, 6000,  20000},

      {33,    12381, 16190, 14762, 14762, 17143, 13333, 15238, 15873,
       15504, 15152, 14815, 15942, 15603, 15238, 12571, 14667, 14379,
       12821, 12579, 13580, 13810, 13095, 12865, 12644, 12429, 13333,
       12022, 11828, 11640, 11458, 11282, 20000},

      {137,   5000,  14000, 13000, 14000, 19000, 12000, 17073, 16667,
       16279, 15909, 15000, 15217, 14894, 14583, 14286, 15000, 13725,
       13462, 13208, 14000, 12727, 12500, 12281, 12069, 11864, 11667,
       11475, 11290, 11111, 10938, 10769, 20000},

      {142,   5000,  15000, 14000, 15000, 16000, 10000, 15000, 17000,
       16279, 15909, 15556, 15217, 14894, 15500, 14286, 13000, 13725,
       13462, 13208, 14000, 12727, 12500, 12281, 12069, 11864, 11667,
       11475, 11290, 11111, 10938, 10769, 20000},

      {143,   7000,  7000,  7000,  7000,  7000,  7000,  12195, 11905,
       11628, 11364, 11111, 12000, 14000, 14000, 12000, 12000, 12000,
       12000, 12500, 12000, 11000, 12500, 11000, 12500, 12000, 13000,
       9000,  9000,  9000,  9000,  9000,  20000},

      {31,    10500, 18500, 19500, 19500, 21500, 15000, 19744, 19274,
       18826, 18398, 18889, 18478, 18500, 18500, 16500, 18000, 17000,
       15000, 15000, 15500, 18500, 15179, 13000, 13500, 14407, 14167,
       15000, 13710, 13492, 13281, 13077, 20000},
  };
