...
/// \file
///
/// \brief Test of generalised CDT geometry.
///
//===----------------------------------------------------------------------===//
...
protected:
  ...
  int TopWire{15};
  int BottomWire{0};
  //                 Cas  Wir Str  SUMO  Xoff
  CDTGeometry SUMO6{CDTGeometry::SUMO6, 10, 16, 16, true, 0};
  CDTGeometry SUMO5{CDTGeometry::SUMO5, 8, 16, 16, true, 20};
  CDTGeometry SUMO4{CDTGeometry::SUMO4, 6, 16, 16, true, 36};
  CDTGeometry SUMO3{CDTGeometry::SUMO3, 4, 16, 16, true, 48};
  CDTGeometry Cuboid{CDTGeometry::Cuboid, 8, 32, 16, true, 0};
  CDTGeometry Mantle{CDTGeometry::Mantle, 6, 32, 256, false, 0};
