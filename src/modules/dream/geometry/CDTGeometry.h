...
//===----------------------------------------------------------------------===//
///
/// \file CDTGeometry is a generalised classfor calculating local x- and y-
/// coordinates for a CDT detector. This should cover properties for
/// EndCaps, Mantle, HR, and SANS detectors for DREAM.
///
//===----------------------------------------------------------------------===//
