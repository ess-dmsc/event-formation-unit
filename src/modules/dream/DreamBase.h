...
template <int Type_t> class DreamBase : public Detector {
...
template <int Type_t>
DreamBase<Type_t>::DreamBase(BaseSettings const &Settings)
    : Detector(Settings) {
...
template <int Type_t> void DreamBase<Type_t>::processingThread() {
  ...
  DreamInstrument<Type_t> Dream(Stats, Counters, EFUSettings, *Serializer,
                                ESSHeaderParser);
