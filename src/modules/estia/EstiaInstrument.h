...
/// \file
///
/// \brief EstiaInstrument is responsible for readout validation and event
/// formation
/// Its functions are called from the main prcessing loop in EstiaBase
//===----------------------------------------------------------------------===//
...
public:
  ...
  /// \brief initialise the serializer. This is used both in EstiaInstrument
  // and EstiaBase. Called from EstiaBase
  void setSerializer(EV44Serializer *serializer) { Serializer = serializer; }

public:
  /// \brief Stuff that 'ties' Estia together
