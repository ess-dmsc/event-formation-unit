...
/// \file
///
/// \brief BIFROST Readout format - heed the warnings below
///
///                              WARNING
///
///                              ACHTUNG
...
struct __attribute__((packed)) Readout {
  ...
  static std::string DatasetName() { return "bifrost_readouts"; }
...
namespace datatype {
template <> class TypeTrait<Bifrost::Readout> {
public:
  H5_COMPOUND_DEFINE_TYPE(Bifrost::Readout) {
    H5_COMPOUND_INIT;
