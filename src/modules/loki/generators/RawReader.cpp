...
int LokiReader::read32(uint32_t &val) { return (int)read(fd, &val, 4); }

int LokiReader::read16(uint16_t &val) { return (int)read(fd, &val, 2); }

int LokiReader::read8(uint8_t &val) { return (int)read(fd, &val, 1); }
