...
TEST_F(TREXGeometryTest, DefaultTREX) {
  ASSERT_TRUE(Geom.isWire(VMM0));
  ASSERT_TRUE(Geom.isGrid(VMM1));
  ASSERT_TRUE(Geom.isGrid(VMM2));
}

TEST_F(TREXGeometryTest, XAndZCoordinateCalculations) {
...
TEST_F(TREXGeometryTest, InvalidXAndZCoordinates) {
  // invalid HybridID
...
TEST_F(TREXGeometryTest, YCoordinateCalculations) {
...
TEST_F(TREXGeometryTest, InvalidYCoordinates) {
