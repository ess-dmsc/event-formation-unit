...
struct pos FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum { VT_STRIP = 4, VT_TIME = 6, VT_ADC = 8 };
  uint32_t strip() const { return GetField<uint32_t>(VT_STRIP, 0); }
  uint32_t time() const { return GetField<uint32_t>(VT_TIME, 0); }
  uint32_t adc() const { return GetField<uint32_t>(VT_ADC, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint32_t>(verifier, VT_STRIP) &&
           VerifyField<uint32_t>(verifier, VT_TIME) &&
           VerifyField<uint32_t>(verifier, VT_ADC) && verifier.EndTable();
  }
};
...
struct posBuilder {
  ...
  void add_adc(uint32_t adc) { fbb_.AddElement<uint32_t>(pos::VT_ADC, adc, 0); }
...
inline flatbuffers::Offset<pos> Createpos(flatbuffers::FlatBufferBuilder &_fbb,
                                          uint32_t strip = 0, uint32_t time = 0,
                                          uint32_t adc = 0) {
...
struct GEMTrack FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVectorOfTables(ytrack()) && verifier.EndTable();
  }
};
...
struct GEMHist FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(yhist()) && verifier.EndTable();
  }
};
...
CreateGEMHist(flatbuffers::FlatBufferBuilder &_fbb,
...
CreateGEMHistDirect(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateGEMHist(_fbb, xhist ? _fbb.CreateVector<uint32_t>(*xhist) : 0,
...
inline flatbuffers::Offset<MonitorMessage> CreateMonitorMessageDirect(
    ...
    DataField data_type = DataField_NONE, flatbuffers::Offset<void> data = 0) {
...
inline const char *MonitorMessageIdentifier() { return "moXX"; }
